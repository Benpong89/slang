      ...
      <div className="splash-container">
        ...
        <header className="splash-header">
          <div className='logo-nav'>
            ...
            <nav onMouseOver={this.toggle3} onMouseLeave={this.toggle3} className='nav-link-drops'>Resources</nav>
              <div className={'hidden' + (this.state.active3 ? ' active3' : '')}>Stay up to date with the latest Slang! #yolo #lit</div>

            <nav onMouseOver={this.toggle4} onMouseLeave={this.toggle4} className='nav-link-drops' to="/" >Pricing</nav>
              <div className={'hidden' + (this.state.active4 ? ' active4' : '')}>Priceless</div>
